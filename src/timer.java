...
//for the actually sorting implementation. The code for the main method is my own.
...
public class timer
{
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("It takes " + avg1 + " to sort an array of size " + runs + "");
    	...
    	System.out.println("It takes " + avg2 + " to sort an array of size " + (2*runs));
